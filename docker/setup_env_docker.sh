...
echo "==> lerobot 基础 + 训练 + HIL-SERL"
# Keep extras in ONE controlled install path when rebuilding RL images.
# Note: hilserl pulls grpc/gym_hil/placo; resolve against pinned torch in requirements.txt.
